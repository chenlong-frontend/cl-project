...
<script>
  ...
  export default {
    ...
    components: { navCom, footerCom, markdownCom },
    data() {
      return {}
    }
  }
...
<style scoped>
  .container {margin-top: 65px;padding: 25px 0;}
  .content {width: 768px;margin: 0 auto;padding: 25px;border-radius: 3px;background-color: #ffffff;}
</style>
