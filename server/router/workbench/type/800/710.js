let menu = [
  ...
  },
  {
    form_id: '14',
    name: '上传文档',
    router_json: '{"path":"/md-upload","component":"md/upload","model":"static"}'
  },
  {
    form_id: '15',
    name: '工作区文件夹',
    router_json: '{"path":"/md-workFolder","component":"md/workFolder","model":"md","child":[{"name": "文件夹","path":":model/:path","component": "components/md/folder"}]}'
  },
  {
    form_id: '16',
    name: '分公司管理',
